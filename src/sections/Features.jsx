                ...
                <div className="flex flex-col justify-center items-center overflow-hidden">
                    ...
                    <div className="w-full flex-center flex-col gap-1">
                        <div className="w-full h-[50vh] flex items-start max-md:features_video_bg">
                            <video playsInline id='exploreVideo' className="w-full h-full object-cover object-top will-change-transform" preload='none' muted autoPlay ref={exploreVideoRef}>
                        ...
                        <div className="flex flex-col w-full relative">
                            <div className="overflow-hidden feature-video-container gap-1">
                                <div className="overflow-hidden flex-1 h-[50vh] bg-zinc">
                                    <img src={explore1Img} alt="titanium" className="feature-video will-change-transform g_grow"/>
                                </div>
                                <div className="overflow-hidden flex-1 h-[50vh] bg-zinc">
                                    <img src={explore2Img} alt="titanium2" className="feature-video will-change-transform g_grow"/>
                                </div>
                            </div>  
                        </div>
                    </div>
                    <div className="feature-text-container">
                        <div className="flex-1 flex-center">
                            <p className="feature-text will-change-transform g_text">
                                iPhone 15 is {" "}
